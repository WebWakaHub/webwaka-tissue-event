...
// Tissue Identity
export const TISSUE_ID = 'TIS-EVENT-v0.1.0' as const;
export const TISSUE_HASH = '2c3b5f3b' as const;
export const CLASSIFICATION = 'Cross-Functional' as const;
export const COMPOSED_CELLS = ['CEL-EVENTBUS', 'CEL-EVENTSTORE', 'CEL-EVENTROUTER'] as const;
